...
void setup(){
  xservo.attach(3); //(analog pin 0) for the x servo was 14
  yservo.attach(4);  //(analog pin 1) for the y server was 15
    xservo.write(90); // set servo's in 90 degree position
    yservo.write(90); // set servo's in 90 degree position
